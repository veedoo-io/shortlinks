...
Route::get('/', [\App\Http\Controllers\GPT\GPTController::class, 'index'])->name('gpt.index');
Route::post('/', [\App\Http\Controllers\GPT\GPTController::class, 'create'])->name('gpt.create');
